      ...
      <div className="mt-5 px-6">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-600 mt-3">
                        Just tell us your trip preferences, and we'll provide
            the best itinerary tailored to your needs.          
          </p>
                 
        </div>
               
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-4">
              ...
              {["Cheap", "Moderate", "Luxury"].map((option) => (
                <button
                  key={option}
                  className={`p-4 border rounded-xl text-center shadow-lg hover:shadow-xl ${
                    budget === option ? "border-blue-500 bg-blue-100" : ""
                  }`}
